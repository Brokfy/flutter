...
class CodigoRecuperacionScreen extends StatefulWidget {
  @override
  _CodigoRecuperacionScreenState createState() => _CodigoRecuperacionScreenState();
}
  ...
  Future<bool> _onWillPop() async {
    return (await showDialog(
      ...
      builder: (BuildContext context) => CupertinoAlertDialog(
        ...
        content: Text(
          "¿Realmente desea cancelar la verificación de su teléfono?",
          style: TextStyle(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    'Por favor ingresa los 6 dígitos que enviamos via SMS para reestablecer contraseña. ',
                    style: TextStyle(
                                    ...
                                    showGeneralDialog(
                                      ...
                                      pageBuilder: (BuildContext buildContext, Animation animation, Animation secondaryAnimation) {
                                        return MessageInfo(
                                          ...
                                          message: "Te hemos reenviado el código. Porfavor revisa tus SMS.",
                                          onTap: () {
